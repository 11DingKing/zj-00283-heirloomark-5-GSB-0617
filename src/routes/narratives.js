...
const db = require("../db");
const { computeNarrativeStatus } = require("../utils/narrativeVerification");
...
function recountVerifications(narrativeId) {
  ...
  const { status, verifiedAt } = computeNarrativeStatus(confirmed, doubted);
...
router.post("/:id/verify", (req, res) => {
  ...
  const tx = db.transaction(() => {
    ...
    return recountVerifications(req.params.id);
  });
